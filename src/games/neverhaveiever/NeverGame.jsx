...
const CARDS = {
  tame: [
    ...
    "regifted a present",
    "lied about my age",
    "worn the same outfit two days in a row and pretended it was fresh",
    "said 'I'm on my way' when I hadn't left the house yet",
    "been caught snooping through someone's stuff",
    "faked being busy to avoid someone",
    "called someone the wrong name and just kept going",
    "walked into a glass door in public",
    "pretended to laugh at a joke I didn't get",
    "bought something I could not afford just to keep up",
    "stayed in a group chat I never unmuted",
    "fallen asleep during a phone call",
    "sent a reaction to the wrong chat",
    "panic-cleaned my room when someone said they were coming over",
    "memorised a playlist just to seem like I had good taste",
    "read a message and then pretended I hadn't seen it yet",
    "accidentally called someone the wrong name during an introduction",
    "waved back at someone who wasn't actually waving at me",
    "pretended to remember someone's name when I'd completely forgotten it",
    "eaten cereal with no milk because I was too lazy to go to the shop",
    "googled 'am I normal' and found it weirdly comforting",
    "had an entire fake argument in my head and got genuinely annoyed",
    "rehearsed a conversation in my head that never happened",
    "taken a 'quick nap' and woken up 4 hours later",
    "screenshot something just to show someone else later",
    "rewatched a video clip in public and laughed again out loud",
    "re-read a text I sent just to admire it",
    "given myself a pep talk in the mirror",
    "charged my phone at a restaurant or café without asking",
    "pretended not to speak the language to avoid a conversation",
    "checked if a door was locked more than three times before leaving",
  ],
  spicy: [
    ...
    "written a strongly worded text and then deleted it without sending",
    "unmatched someone on a dating app immediately after matching",
    "made up a story to seem more interesting on a date",
    "gone through someone's following list out of jealousy",
    "pretended to be asleep to avoid having a conversation",
    "cried in a bathroom at a party",
    "developed feelings for someone I absolutely should not have",
    "been secretly relieved when plans got cancelled",
    "drunk texted my ex and then immediately turned my phone off",
    "made a fake excuse to leave somewhere just because I was bored",
    "thought about an ex while with someone else",
    "subtly competed with a friend without ever admitting it",
    "kept talking to someone I knew wasn't good for me just because it felt exciting",
    "said something sarcastic when I actually meant it",
    "pretended not to care about something I cared about deeply",
    "read someone's messages through their phone without permission",
    "had a dream about someone in this room and never told them",
    "left someone on read intentionally just to seem less eager",
    "deleted my own social media posts because they didn't get enough likes",
    "given someone a fake number",
    "pretended I'd moved on way before I actually had",
    "had two conversations going with two different people about each other",
    "used someone's feelings for me to my own advantage",
    "been the one who pulled away first just to feel more in control",
    "talked badly about a friend's partner when I actually agreed with their choices",
    "convinced myself I was okay and then completely fallen apart a week later",
    "told someone they were overreacting when I knew deep down they weren't",
    "liked someone much more than I let on because it felt safer",
    "started an argument just because I was in a bad mood and wanted company in it",
  ],
}
