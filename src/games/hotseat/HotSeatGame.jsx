...
const QUESTIONS = {
  mild: [
    ...
    "What's a compliment you've received that you secretly loved but played off as no big deal?",
    "What's the most embarrassing autocorrect fail you've sent to the wrong person?",
    "What's a movie, show, or book you pretend you've seen or read but never actually have?",
    "What's your most unpopular food opinion?",
    "What's a phase or hobby you went through that you'd rather nobody knew about?",
    "What's something you've bought that you immediately regretted?",
    "What's a rule you break on a regular basis with zero guilt?",
    "What's the pettiest reason you've ever been annoyed at someone?",
    "What's the strangest thing you've done when you're completely alone?",
    "What's the last thing you searched on YouTube at 2am?",
    "What's something you've Googled that you'd be embarrassed to explain?",
    "What's the most overdramatic thing you've ever done?",
    "What's something you were completely wrong about for a long time before you found out?",
    "What's a talent or skill you wish you had but gave up trying to learn?",
    "What's the worst excuse you've ever used to get out of something?",
    "What's a habit that you know is bad but genuinely cannot stop?",
    "What's the most childish argument you've ever gotten into?",
    "What's something you've lied to yourself about for a really long time?",
    "What's the most embarrassing thing you've said during a phone or video call?",
    "What's a celebrity or famous person you have an irrational dislike of?",
    "What's the most ridiculous hill you've died on in an argument?",
    "What's something you do that you'd never admit makes you feel proud?",
    "What's the most embarrassing thing in your notes app right now?",
    "What's a totally mundane thing you are secretly very competitive about?",
    "What's the most expensive thing you've ever lost or broken?",
    "What's something you've pretended to understand in conversation but had no clue about?",
    "What's the most embarrassing voicemail you've left someone?",
    "What's a completely irrational superstition or ritual you still follow?",
    "What's the most cringe thing in your camera roll that you keep forgetting to delete?",
  ],
  spicy: [
    ...
    "What's the most manipulative thing you've ever done to get what you wanted?",
    "Who here do you think would crack first under pressure in a crisis?",
    "What's the most savage thing you've ever said to someone that you've never apologized for?",
    "What's the biggest secret you're currently keeping from your family?",
    "What's something you've done that, if it came out, would genuinely change how people see you?",
    "What's the most embarrassing thing you've done while drunk that sober you has to live with?",
    "Who here have you been most fake with at some point?",
    "What's the most self-destructive thing you've done for someone else?",
    "What's the worst thing you've thought about someone in this room that you'd never say out loud?",
    "What's a time you let someone take the blame for something you did?",
    "What's the most immature way you've handled a breakup or falling out?",
    "What's your most embarrassing reason for ending or ghosting a relationship?",
    "What's something you've done that you told yourself was justified but deep down you know wasn't?",
    "Who here would you be most nervous to be stuck in an elevator with for 3 hours?",
    "What's the shadiest thing you've done that nobody ever found out about?",
    "What's the most embarrassing thing you've done to get someone's attention?",
    "What's a genuine character flaw you have that you've never actually tried to fix?",
    "What's the biggest lie you've told someone to protect yourself rather than them?",
    "What's a relationship in your life that you know is unhealthy but you keep maintaining anyway?",
    "What's something you've said to someone's face that you completely didn't mean?",
    "What's the most embarrassing thing you've done on social media that you then deleted?",
    "What's the most passive aggressive thing you've ever done to someone?",
    "Who here do you think you've underestimated the most?",
    "What's a lie you've told so many times it's starting to feel true?",
    "What's the most jealous you've ever felt of a close friend?",
    "What's something you've said to make yourself seem more interesting or impressive than you are?",
    "What's the most deliberately petty thing you've done to get back at someone?",
    "Who here do you think secretly judges you the most?",
    "What's something you know is wrong about how you treat someone in your life but haven't changed?",
  ],
}
