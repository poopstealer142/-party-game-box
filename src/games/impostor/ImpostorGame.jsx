...
const DEFAULT_PACKS = [
  {
    ...
    name: 'Places',
    emoji: '🗺',
    words: ['Beach','Airport','Hospital','Library','Casino','Zoo','Museum','Restaurant','School','Office','Space Station','Submarine','Pirate Ship','Jungle','Antarctica','Prison','Volcano','Haunted House','Skyscraper','Farm','Cruise Ship','Circus','Underground Bunker','Medieval Castle','Theme Park','Rainforest','Train Station','Supermarket','Sewers','The Moon'],
  },
  {
    id: 'jobs',
    name: 'Jobs',
    emoji: '💼',
    words: ['Chef','Astronaut','Detective','Surgeon','Firefighter','Spy','Teacher','Pilot','Archaeologist','Clown','Lawyer','Mechanic','Photographer','Sailor','Barista','Hacker','Undertaker','Ghost Hunter','Magician','Hitman','Zookeeper','Taxidermist','Bomb Disposal Expert','Competitive Eater','Stunt Double','Bounty Hunter','Tattoo Artist','Escape Room Designer','Cryptographer','Mime'],
  },
  {
    id: 'activities',
    name: 'Activities',
    emoji: '⚽',
    words: ['Skydiving','Cooking','Yoga','Rock Climbing','Painting','Karaoke','Surfing','Chess','Bungee Jumping','Meditation','Pottery','Archery','Scuba Diving','Baking','Disco Dancing','Parkour','Axe Throwing','Cage Fighting','Speed Dating','Escape Room','Ghost Hunting','Ice Carving','Goat Yoga','Competitive Eating','Sword Swallowing','Ferret Racing','Extreme Ironing','Bog Snorkelling','Wife Carrying','Cheese Rolling'],
  },
  {
    id: 'movies',
    name: 'Movies & TV',
    emoji: '🎬',
    words: ['Horror Movie','Reality Show','Documentary','Soap Opera','Action Movie','Animated Film','Game Show','True Crime','Fantasy Series','Romantic Comedy','News Channel','Sports Broadcast','Cooking Show','Nature Documentary','Crime Thriller','Zombie Apocalypse Film','Found Footage Movie','Mockumentary','Superhero Movie','Heist Film','Teen Drama','Period Drama','Slasher Film','Spy Thriller','Psychological Horror','Disaster Movie','Buddy Comedy','Musical','Sci-Fi Epic','Body Swap Comedy'],
  },
  {
    id: 'food',
    name: 'Food',
    emoji: '🍕',
    words: ['Pizza','Sushi','Tacos','Ice Cream','Ramen','Burger','Croissant','Dim Sum','BBQ','Salad','Pasta','Fried Chicken','Cheesecake','Hot Pot','Paella','Pho','Banh Mi','Dumplings','Currywurst','Shakshuka','Jerk Chicken','Bibimbap','Gumbo','Pierogi','Falafel','Peking Duck','Lobster Roll','Churros','Beef Wellington','Truffle','Caviar','Durian','Instant Noodles','Century Egg','Fermented Shark'],
  },
  {
    id: 'demon_slayer',
    name: 'Demon Slayer',
