...
const RULE_PROMPTS = [
  ...
  'You are something people eat for breakfast',
  'You are a mode of transport',
  'You are something found in a kitchen',
  'You are a planet or celestial body',
  'You are a type of weather',
  'You have been to space',
  'You are something that glows',
  'You are a sport or game',
  'You are smaller than a shoe',
  'You are something you find at a beach',
  'You are a colour',
  'You are a famous building or landmark',
  'You are a type of job or profession',
  'You are something that makes a loud noise',
  'You are from a video game',
  'You are something you can fold',
  'You are a type of weapon',
  'You are something people are afraid of',
  'You are something that can be both hot and cold',
  'You are something that spins',
  'You are a plant or tree',
]
