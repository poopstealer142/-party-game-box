...
const SPECTRUMS = [
  ...
  { left: 'Overconfident', right: 'Insecure' },
  { left: 'Generous', right: 'Selfish' },
  { left: 'Honest', right: 'Deceptive' },
  { left: 'Spontaneous', right: 'Planned' },
  { left: 'Toxic', right: 'Healthy' },
  { left: 'Legendary', right: 'Forgotten' },
  { left: 'Obsessive', right: 'Indifferent' },
  { left: 'Comforting', right: 'Unsettling' },
  { left: 'Petty', right: 'Forgiving' },
  { left: 'Overpriced', right: 'Bargain' },
  { left: 'Risky', right: 'Cautious' },
  { left: 'Greasy', right: 'Clean' },
  { left: 'Intellectual', right: 'Shallow' },
  { left: 'Underdog', right: 'Favourite' },
  { left: 'Romantic', right: 'Practical' },
  { left: 'Naughty', right: 'Wholesome' },
  { left: 'Epic', right: 'Anticlimactic' },
  { left: 'Pure', right: 'Corrupt' },
  { left: 'Humble', right: 'Showoff' },
  { left: 'Predictable', right: 'Surprising' },
  { left: 'Cursed', right: 'Blessed' },
  { left: 'Loveable', right: 'Insufferable' },
  { left: 'Overhyped', right: 'Hidden gem' },
  { left: 'Gloomy', right: 'Cheerful' },
]
